...
public class TestCooperatorServiceReport {
	...
	// not sure if this test is still relevant since id is autogenerated
	/*
	 * @Test public void testCreateReportNegative() { assertEquals(0,
	 * cs.getAllReports().size());
	 * 
	 * String emailS = "paul.hooley@gmail.com"; String nameS = "qwefqwefq"; String
	 * passwordS = "frisbyislife"; int idS = 3; String phoneS = "6047862815";
	 * Student s;
	 * 
	 * s = cs.createStudent(emailS, nameS, passwordS, phoneS, idS);
	 * 
	 * String emailE = "emma.eagles@mail.mcgill.ca"; String nameE = "Emma Eagles";
	 * String passwordE = "12341234"; String phoneE = "254334"; String companyE =
	 * "lightspeed"; Employer emp;
	 * 
	 * emp = cs.createEmployer(emailE, nameE, passwordE, phoneE, companyE);
	 * 
	 * String title = "Developer"; Date startDate = Date.valueOf("2019-01-01"); Date
	 * endDate = Date.valueOf("2019-04-30"); CoopStatus status =
	 * CoopStatus.NotStarted; Integer salaryPerHour = 19; Integer hoursPerWeek = 40;
	 * String address = "address"; Coop c;
	 * 
	 * c = cs.createCoop(s, emp, title, startDate, endDate, status, salaryPerHour,
	 * hoursPerWeek, address);
	 * 
	 * Date date = Date.valueOf("2019-03-30"); String error = null;
	 * 
	 * try { cs.createReport(c, date, ReportStatus.Submitted, ReportType.Contract);
	 * } catch (IllegalArgumentException e) { error = e.getMessage(); }
	 * 
	 * // check error assertEquals("ID is invalid! ", error);
	 * 
	 * // check no change in memory assertEquals(0, cs.getAllReports().size()); }
	 */
