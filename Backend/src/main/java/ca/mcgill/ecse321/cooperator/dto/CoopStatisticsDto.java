...
public class CoopStatisticsDto {
	...
	public CoopStatisticsDto(String startTerm, String endTerm, Integer coopNumber, Integer notStartedCoops,
			Integer inProgressCoops, Integer completedCoops, Integer totalCoops) {
		super();
