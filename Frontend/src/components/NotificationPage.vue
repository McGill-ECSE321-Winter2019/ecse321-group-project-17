        ...
        sendNotification: function(profiles, message) {
            ...
            if (length == 1) {
                if(profiles[0].company == null) {
                    AXIOS.post(`/notification/create?text=` + message +
                    `&senderEmail=admin@gmail.com&stuEmail=` + profiles[0].email)
                        .then(response => {
                            alert("Success!");
                        })
                        .catch(e => {
                    ...
                    AXIOS.post(`/notification/create?text=` + message +
                    `&senderEmail=admin@gmail.com&empEmail=` + profiles[0].email)
                        .then(response => {
                            alert("Success!");
                        })
                        .catch(e => {
                ...
                if (employers.length == 0) {
                    ...
                    AXIOS.post(`/notification/create-many?text=` + message +
                    `&senderEmail=admin@gmail.com&stuEmail=` + studentEmails)
                        .then(response => {
                            alert("Success!");
                        })
                        .catch(e => {
                    ...
                    AXIOS.post(`/notification/create-many?text=` + message +
                    `&senderEmail=admin@gmail.com&empEmail=` + employerEmails)
                        .then(response => {
                            alert("Success!");
                        })
                        .catch(e => {
